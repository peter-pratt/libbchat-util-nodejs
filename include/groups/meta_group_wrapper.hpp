...
using bchat::config::GROUP_DESTROYED;
using bchat::config::KICKED_FROM_GROUP;
using bchat::config::NOT_REMOVED;
using bchat::config::groups::member;
using bchat::nodeapi::MetaGroup;
