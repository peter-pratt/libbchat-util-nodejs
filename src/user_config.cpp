...
bchat::config::ProConfig pro_config_from_object(Napi::Object input) {
    bchat::config::ProConfig pro_config = {};
...
Napi::Value UserConfigWrapper::generateProMasterKey(const Napi::CallbackInfo& info) {
    return wrapResult(info, [&] {
        ...
        auto pro_master_key_hex = bchat::ed25519::ed25519_pro_privkey_for_ed25519_seed(converted);
