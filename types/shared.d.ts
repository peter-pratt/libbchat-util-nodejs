...
declare module 'libbchat_util_nodejs' {
  ...
  export type ConstantsType = {
     ...
     */
    LIBBCHAT_UTIL_VERSION: string;
    /**
     * A string that looks like "0.4.24"
     */
    LIBBCHAT_NODEJS_VERSION: string;
    /**
     * A string corresponding to the full hash of the commit
     */
    LIBBCHAT_NODEJS_COMMIT: string;
    /** Object containing pro urls **/
    LIBBCHAT_PRO_URLS: ProBackendUrlsType;
    /** Object containing mapped provider constants */
    LIBBCHAT_PRO_PROVIDERS: ProBackendProviderConstantsType;
  };
